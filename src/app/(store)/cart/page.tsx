...
import OrderSummary from "@/domains/store/Cart/OrderSummary";
import CartRowItem from "@/domains/store/shoppingCard/components/shoppingCart/CartRowItem";
        ...
        <section className="overflow-hidden py-20 bg-gray-200">
          <div className="max-w-292.5 w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              ...
              <button className="text-blue-500 hover:text-blue-700">Clear Shopping Cart</button>
            </div>

            <div className="bg-white rounded-[10px] shadow-1">
              <div className="w-full overflow-x-auto">
                <div className="min-w-292.5">
                  {/* <!-- table header --> */}
                  <div className="grid grid-cols-5   divide-y divide-gray-500 py-5.5 ">
                    <div className="">
                  ...
                  {/* <!-- cart item --> */}
                  {cartItems.length > 0 &&
                    cartItems.map((item, key) => <CartRowItem data={item} key={key} onLinkClicked={() => {}} />)}
                </div>
              </div>
            </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <Link
              ...
              className="w-96 mx-auto flex justify-center font-medium text-white bg-gray-800 py-3.25 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95"
            >
              Continue Shopping
            </Link>
          </div>
