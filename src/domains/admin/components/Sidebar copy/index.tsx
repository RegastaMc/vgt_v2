  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 bg-white border-r lg:flex lg:flex-col">
      ...
      <div className="flex h-16 items-center gap-3 px-6 border-b">
        <div className="h-9 w-9 rounded-lg bg-black text-white flex items-center justify-center font-bold">A</div>
      ...
      <div className="px-4 py-4 border-t">
        <button className="flex w-full items-center gap-3 rounded-lg px-4 py-2 text-sm bg-red-400 text-gray-600 hover:bg-red-50 hover:text-red-600 transition">
