...
export default function UserDropdown(props: UserDropdownProps) {
  ...
  const image = "/images/account.png";
    ...
    return (
      <div className="relative z-10">
        <button
          ...
          className="flex items-center gap-1 px-3 py-1 text-gray-700   rounded-lg dark:text-gray-400 dropdown-toggle"
        >
          <User2 size={20} className=" text-gray-500 dark:text-gray-400" />
          <span className="block text-nowrap font-medium text-sm">Get Started</span>
    ...
    <div className="relative z-50">
      <button onClick={toggleDropdown} className="flex items-center text-gray-700 dark:text-gray-400 dropdown-toggle">
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <Image width={44} height={44} src={session?.user?.image || image} alt="User" />
        </span>
          ...
          {session?.user?.role === "ADMIN" && (
            <li>
              <DropdownItem
                onItemClick={closeDropdown}
                tag="a"
                href={`/admin/${session?.user?.id}/categories`}
                className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
              >
                <svg
                  className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
